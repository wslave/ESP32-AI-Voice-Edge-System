...
(101028, 101, '原固件 Mini C3', 'xmini-c3', '原固件 Mini C3', 28, 1, NOW(), 1, NOW()),
...
(101040, 101, 'Movecall Moji ESP32本地AI衍生版', 'movecall-moji-esp32s3', 'Movecall Moji ESP32本地AI衍生版', 40, 1, NOW(), 1, NOW()),
