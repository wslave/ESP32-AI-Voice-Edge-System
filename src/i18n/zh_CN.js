export default {
  ...
  'firmwareDialog.uploadHint': '温馨提示：请上传合并前的firmware.bin文件，而不是合并后的merged-binary.bin文件',
  ...
  // 注册页面相关
  'register.title': '创建账号',
  'register.welcome': '欢迎使用ESP32本地AI',
  ...
  'paramManagement.updateSuccess': '修改成功，部分配置需重启local-ai-host模块才生效',
  ...
  'roleConfig.tooltip.contextProvider': '在语音助手被唤醒时，获取外部系统的数据，并将其动态注入到大模型的系统提示词中',
  ...
  'modelConfig.setDefaultSuccess': '设置默认模型成功，请及时手动重启local-ai-host模块',
