export default {
  ...
  'firmwareDialog.uploadHint': '溫馨提示：請上傳合併前的firmware.bin文件，而不是合併後的merged-binary.bin文件',
  ...
  'paramManagement.updateSuccess': '修改成功，部分配置需重啟local-ai-host模組才生效',
  ...
  'roleConfig.tooltip.contextProvider': '在语音助手被喚醒時，獲取外部系統的資料，並將其動態注入到大模型的系統提示詞中',
  ...
  'modelConfig.setDefaultSuccess': '設置默認模型成功，請及時手動重啟local-ai-host模組',
