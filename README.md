...
This repository combines the restored ESP32 hardware firmware with a retained Web management UI for the ESP32 plus local AI host voice interaction control system.
