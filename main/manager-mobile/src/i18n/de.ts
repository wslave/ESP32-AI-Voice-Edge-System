...
export default {
  ...
  'manualAddDeviceDialog.bindWithCode': 'Mit 6-stelligem Code binden',
    ...
    // Über uns
    'settings.aboutApp': 'Über ESP32 Voice Konsole',
    'settings.aboutContent': 'ESP32 Voice Konsole\n\nEine plattformübergreifende mobile Management-App, erstellt mit Vue.js 3 + uni-app, bietet Geräteverwaltung, Agentenkonfiguration und andere Funktionen für ESP32 voice terminal Smart Hardware.\n\nESP32-AI-Voice-Edge-System {version}',
    ...
    'deviceConfig.connectToVoiceHotspot': 'Bitte verbinden Sie sich zuerst mit dem ESP32 voice hotspot',
    'deviceConfig.detecting': 'Erkennen...',
    'deviceConfig.reDetect': 'Erneut erkennen',
    'deviceConfig.alreadyConnected': 'Mit ESP32 voice hotspot verbunden',
    ...
    'deviceConfig.bringPhoneCloseToVoiceDevice': 'Bringen Sie das Telefon in die Nähe des ESP32 voice terminal (1-2 Meter Entfernung)',
    'deviceConfig.duringAudioPlaybackVoiceTerminalWillReceive': 'Während der Audio-Wiedergabe empfängt ESP32 voice terminal und dekodiert Konfigurationsinformationen',
    ...
    'deviceConfig.connectVoiceHotspot': 'Bitte verbinden Sie sich mit dem ESP32 voice hotspot',
    ...
    'deviceConfig.connectedVoiceHotspot': 'Mit ESP32 voice hotspot verbunden',
    ...
    'deviceConfig.pleaseDisconnectVoiceHotspot': 'Bitte trennen Sie sich vom ESP32 voice hotspot',
    ...
    'deviceConfig.phoneConnectVoiceHotspot': 'Telefon mit ESP32 voice hotspot verbinden',
