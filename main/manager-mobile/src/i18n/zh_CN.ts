...
export default {
  ...
  // 关于我们
  'settings.aboutApp': '关于ESP32本地AI语音控制台',
  'settings.aboutContent': 'ESP32本地AI语音控制台\n\n基于 Vue.js 3 + uni-app 构建的跨平台移动端管理应用，为语音助手ESP32智能硬件提供设备管理、智能体配置等功能。\n\nESP32-AI-Voice-Edge-System {version}',
  ...
  'deviceConfig.connectToVoiceHotspot': '请先连接ESP32语音终端热点 (ESP32-VOICE-XXXXXX)',
  'deviceConfig.detecting': '检测中...',
  'deviceConfig.reDetect': '重新检测',
  'deviceConfig.alreadyConnected': '已连接ESP32语音终端热点',
  ...
  'deviceConfig.bringPhoneCloseToVoiceDevice': '将手机靠近ESP32语音终端（距离1-2米）',
  'deviceConfig.duringAudioPlaybackVoiceTerminalWillReceive': '音频播放时，ESP32语音终端会接收并解码配网信息',
  ...
  'deviceConfig.connectVoiceHotspot': '请连接ESP32语音终端热点',
  ...
  'deviceConfig.connectedVoiceHotspot': '已连接ESP32语音终端热点',
  ...
  'deviceConfig.pleaseDisconnectVoiceHotspot': '请断开ESP32语音终端热点连接',
  ...
  'deviceConfig.phoneConnectVoiceHotspot': '手机连接ESP32语音终端热点',
