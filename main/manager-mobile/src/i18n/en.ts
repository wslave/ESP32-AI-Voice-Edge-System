...
export default {
  ...
  // About us
  'settings.aboutApp': 'About ESP32 Local AI Voice Console',
  'settings.aboutContent': 'ESP32 Local AI Voice Console\n\nA cross-platform mobile management app built with Vue.js 3 + uni-app, providing device management, agent configuration and other functions for ESP32 voice terminal.\n\nESP32-AI-Voice-Edge-System {version}',
  ...
  'deviceConfig.connectToVoiceHotspot': 'Please connect to ESP32 voice hotspot first',
  'deviceConfig.detecting': 'Detecting...',
  'deviceConfig.reDetect': 'Re-detect',
  'deviceConfig.alreadyConnected': 'Connected to ESP32 voice hotspot',
  ...
  'deviceConfig.bringPhoneCloseToVoiceDevice': 'Bring phone close to ESP32 voice device (1-2 meters distance)',
  'deviceConfig.duringAudioPlaybackVoiceTerminalWillReceive': 'During audio playback, ESP32 voice terminal will receive and decode configuration information',
  ...
  'deviceConfig.connectVoiceHotspot': 'Please connect to ESP32 voice hotspot',
  ...
  'deviceConfig.connectedVoiceHotspot': 'Connected to ESP32 voice hotspot',
  ...
  'deviceConfig.pleaseDisconnectVoiceHotspot': 'Please disconnect from ESP32 voice hotspot',
  ...
  'deviceConfig.phoneConnectVoiceHotspot': 'Phone connect to ESP32 voice hotspot',
