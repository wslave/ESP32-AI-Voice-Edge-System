...
export default {
  ...
  // 關於我們
  'settings.aboutApp': '關於ESP32本地AI语音控制台',
  'settings.aboutContent': 'ESP32本地AI语音控制台\n\n基於 Vue.js 3 + uni-app 構建的跨平台移動端管理應用，為语音助手ESP32智能硬體提供設備管理、智能體配置等功能。\n\nESP32-AI-Voice-Edge-System {version}',
  ...
  'deviceConfig.connectToVoiceHotspot': '請先連接ESP32語音終端熱點 (ESP32-VOICE-XXXXXX)',
  'deviceConfig.detecting': '檢測中...',
  'deviceConfig.reDetect': '重新檢測',
  'deviceConfig.alreadyConnected': '已連接ESP32語音終端熱點',
  ...
  'deviceConfig.bringPhoneCloseToVoiceDevice': '將手機靠近ESP32語音終端（距離1-2米）',
  'deviceConfig.duringAudioPlaybackVoiceTerminalWillReceive': '音頻播放時，ESP32語音終端會接收並解碼配網信息',
  ...
  'deviceConfig.connectVoiceHotspot': '請連接ESP32語音終端熱點',
  ...
  'deviceConfig.connectedVoiceHotspot': '已連接ESP32語音終端熱點',
  ...
  'deviceConfig.pleaseDisconnectVoiceHotspot': '請斷開ESP32語音終端熱點連接',
  ...
  'deviceConfig.phoneConnectVoiceHotspot': '手機連接ESP32語音終端熱點',
