...
export default {
  ...
  'manualAddDeviceDialog.bindWithCode': 'Liên kết bằng mã xác minh 6 chữ số',
    ...
    // Về chúng tôi
    'settings.aboutApp': 'Về Bảng điều khiển ESP32 Voice',
    'settings.aboutContent': 'Bảng điều khiển ESP32 Voice\n\nỨng dụng quản lý di động đa nền tảng được xây dựng với Vue.js 3 + uni-app, cung cấp quản lý thiết bị, cấu hình đại lý và các chức năng khác cho phần cứng thông minh ESP32 voice terminal.\n\nESP32-AI-Voice-Edge-System {version}',
    ...
    'deviceConfig.connectToVoiceHotspot': 'Vui lòng kết nối với điểm phát sóng ESP32 voice trước',
    'deviceConfig.detecting': 'Đang phát hiện...',
    'deviceConfig.reDetect': 'Phát hiện lại',
    'deviceConfig.alreadyConnected': 'Đã kết nối với điểm phát sóng ESP32 voice',
    ...
    'deviceConfig.bringPhoneCloseToVoiceDevice': 'Đưa điện thoại lại gần thiết bị ESP32 voice (khoảng cách 1-2 mét)',
    'deviceConfig.duringAudioPlaybackVoiceTerminalWillReceive': 'Trong khi phát âm thanh, thiết bị ESP32 sẽ nhận và giải mã thông tin cấu hình',
    ...
    'deviceConfig.connectVoiceHotspot': 'Vui lòng kết nối với điểm phát sóng ESP32 voice',
    ...
    'deviceConfig.connectedVoiceHotspot': 'Đã kết nối với điểm phát sóng ESP32 voice',
    ...
    'deviceConfig.pleaseDisconnectVoiceHotspot': 'Vui lòng ngắt kết nối khỏi điểm phát sóng ESP32 voice',
    ...
    'deviceConfig.phoneConnectVoiceHotspot': 'Điện thoại kết nối với điểm phát sóng ESP32 voice',
