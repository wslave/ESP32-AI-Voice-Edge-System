export default {
  ...
  'register.welcome': 'Welcome to ESP32 Local AI',
  ...
  'paramManagement.updateSuccess': 'Update successful. Some configurations will take effect only after restarting the local-ai-host module.',
  ...
  'roleConfig.tooltip.contextProvider': 'When ESP32 Voice is awakened, fetch external system data and dynamically inject it into the LLM system prompt',
  ...
  'modelConfig.setDefaultSuccess': 'Set default model successful, please restart the local-ai-host module manually in time',
