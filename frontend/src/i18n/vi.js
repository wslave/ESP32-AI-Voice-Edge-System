export default {
  ...
  'firmwareDialog.uploadHint': 'Nhắc nhở: Vui lòng tải lên tệp firmware.bin đã hợp nhất trước, không phải tệp merged-binary.bin đã hợp nhất',
  ...
  'register.welcome': 'Chào mừng đến với ESP32 Local AI',
  ...
  // System information
  'system.name': 'Dịch vụ ESP32 Voice',
  ...
  'home.greeting': 'Xin chào ESP32 Voice',
  ...
  'paramManagement.updateSuccess': 'Cập nhật thành công. Một số cấu hình chỉ có hiệu lực sau khi khởi động lại mô-đun local-ai-host.',
  ...
  'roleConfig.tooltip.contextProvider': 'Khi ESP32 Voice được kích hoạt, lấy dữ liệu từ hệ thống bên ngoài và tiêm động vào lời nhắc hệ thống của LLM',
  ...
  'modelConfig.setDefaultSuccess': 'Đặt mô hình mặc định thành công, vui lòng khởi động lại module local-ai-host thủ công kịp thời',
